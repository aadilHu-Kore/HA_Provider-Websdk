...
//----------aadil added--------
		} else if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type == "date-timeslots") {
			messageHtml = $(this.getChatTemplate("dateTimeslots")).tmpl({
				'msgData': msgData,
				'helpers': this.helpers,
				'extension': this.extension
			});
...
//--------Aadil added-----------------
var dateTimeslots = '<script id="chat_message_tmpl"> \
			{{if msgData.message}} \
				<li {{if msgData.type !== "bot_response"}}  {{/if}} id="${msgData.messageId}" class="{{if msgData.type === "bot_response"}} fromOtherUsers{{else}}fromCurrentUser{{/if}} with-icon"> \
					<div class = "timeSlotsMainDiv"> \
						<div class = "timeSlotsChildVDiv"> \
							<img src = "data:image/svg+xml;base64,"> \
							<span class = "meeting">${msgData.message[0].component.payload.label} </span> \
							<span class = "minutes">${msgData.message[0].component.payload.duration}</span> \
						</div> \
						<div> \
							<div class = "scheduleMeeting"> \
								<div class = "profileDivMeeting"> \
									<div class = "profileDiv"> \
										<span class= "profileName">${msgData.message[0].component.payload.name}</span> \
									</div> \
								</div> \
							</div>\
							<div class = "selectDay"> \
								<span>Select a Day</span> \
								<span class="timeZoneContainer"> \
								<span class="timeZoneDropDown dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> \
									${msgData.message[0].component.payload.timezone} \
								</span> \
								<div class="dropdown-menu dropdown-menu-right"> \
									<div class="backDiv">\
										<img src = "data:image/svg+xml;base64,"> \
										<span class="text">Timezone</span> \
									</div> \
									<div class="searchDiv"> \
										<input placeholder="Search" class="searchTimeZone" id = "myInput"> \
									</div> \
									<div class="timeZoneList" id = "dropDown"> \
										{{each(key, timeZone) msgData.message[0].component.payload.timeSlots}} \
											<span class="dropdown-item" data-timeZone = "${timeZone}">${timeZone}</span> \
										{{/each}} \
									</div> \
								</div> \
							</span> \
							...
							<div> \
								...
								<div class = "timeSlotsDiv" style = "border-bottom: 1px solid #dcdcdc"> \
									<div class = "timeSlots" id = "dynamicTimeSlots"> \
									</div> \
								</div> \
							</div> \
							<div class = "scheduleDiv hide"> \
								<span class = "showLeftArow"> \
									<img src = "data:image/svg+xml;base64,"> \
								</span> \
								<div class = "profileMeeingDetails"> \
									<span class= "profileName">${msgData.message[0].component.payload.name}</span> \
									<span class= "meetingDayValue"></span> \
									<div class = "displayClass"> \
										<span class= "meetingTimeValue"></span> \
										<span class = "meetingZoneValue"></span> \
									</div> \
									<span class = "meetingTimeZone"></span>\
									<button type="postback" class = "schedule">Go!</button> \
								</div> \
							</div> \
						</div> \
					</div> \
...
//-------------------------------
if(tempType === "dateTimeslots"){
	return dateTimeslots;
} else if (tempType === "dropdown_template") {
